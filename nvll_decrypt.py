...
def descifrar_nvll(texto, clave_base, desplazamiento):
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) != 4:
        print("Uso: python nvll_decrypt.py <mensaje_cifrado> <clave_base> <desplazamiento>")
    else:
        mensaje = sys.argv[1]
        clave_base = sys.argv[2]
        desplazamiento = int(sys.argv[3])
        descifrado = descifrar_nvll(mensaje, clave_base, desplazamiento)
